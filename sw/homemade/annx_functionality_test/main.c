...
int main(void) {
    ...
    result = annx_exp((uint32_t)((int32_t)-655360)); neorv32_uart0_printf("exp(-10)  =  "); print_q16(result); neorv32_uart0_printf("\n");
    result = annx_exp((uint32_t)((int32_t)-524288)); neorv32_uart0_printf("exp(-8)   =  "); print_q16(result); neorv32_uart0_printf("\n");
    result = annx_exp((uint32_t)((int32_t)-393216)); neorv32_uart0_printf("exp(-6)   =  "); print_q16(result); neorv32_uart0_printf("\n");
    result = annx_exp((uint32_t)((int32_t)-262144)); neorv32_uart0_printf("exp(-4)   =  "); print_q16(result); neorv32_uart0_printf("\n");
    result = annx_exp((uint32_t)((int32_t)-131072)); neorv32_uart0_printf("exp(-2)   =  "); print_q16(result); neorv32_uart0_printf("\n");
    result = annx_exp((uint32_t)((int32_t)-65536)); neorv32_uart0_printf("exp(-1)   =  "); print_q16(result); neorv32_uart0_printf("\n");
    result = annx_exp((uint32_t)((int32_t)0)); neorv32_uart0_printf("exp(0)    =  "); print_q16(result); neorv32_uart0_printf("\n");
    result = annx_exp((uint32_t)((int32_t)65536)); neorv32_uart0_printf("exp(1)    =  "); print_q16(result); neorv32_uart0_printf("\n");
    result = annx_exp((uint32_t)((int32_t)131072)); neorv32_uart0_printf("exp(2)    =  "); print_q16(result); neorv32_uart0_printf("\n");
    result = annx_exp((uint32_t)((int32_t)262144)); neorv32_uart0_printf("exp(4)    =  "); print_q16(result); neorv32_uart0_printf("\n");
    result = annx_exp((uint32_t)((int32_t)393216)); neorv32_uart0_printf("exp(6)    =  "); print_q16(result); neorv32_uart0_printf("\n");
