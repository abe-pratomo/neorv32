...
void run_test(int n) {
    ...
    if (n >= 64)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 63);
    if (n >= 65)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 64);
    if (n >= 66)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 65);
    if (n >= 67)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 66);
    if (n >= 68)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 67);
    if (n >= 69)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 68);
    if (n >= 70)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 69);
    if (n >= 71)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 70);
    if (n >= 72)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 71);
    if (n >= 73)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 72);
    if (n >= 74)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 73);
    if (n >= 75)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 74);
    if (n >= 76)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 75);
    if (n >= 77)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 76);
    if (n >= 78)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 77);
    if (n >= 79)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 78);
    if (n >= 80)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 79);
    if (n >= 81)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 80);
    if (n >= 82)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 81);
    if (n >= 83)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 82);
    if (n >= 84)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 83);
    if (n >= 85)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 84);
    if (n >= 86)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 85);
    if (n >= 87)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 86);
    if (n >= 88)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 87);
    if (n >= 89)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 88);
    if (n >= 90)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 89);
    if (n >= 91)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 90);
    if (n >= 92)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 91);
    if (n >= 93)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 92);
    if (n >= 94)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 93);
    if (n >= 95)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 94);
    if (n >= 96)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 95);
    if (n >= 97)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 96);
    if (n >= 98)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 97);
    if (n >= 99)  sum_annx = annx_lwa((uint32_t)values, sum_annx, 98);
    if (n >= 100) sum_annx = annx_lwa((uint32_t)values, sum_annx, 99);
    if (n >= 101) sum_annx = annx_lwa((uint32_t)values, sum_annx, 100);
    if (n >= 102) sum_annx = annx_lwa((uint32_t)values, sum_annx, 101);
    if (n >= 103) sum_annx = annx_lwa((uint32_t)values, sum_annx, 102);
    if (n >= 104) sum_annx = annx_lwa((uint32_t)values, sum_annx, 103);
    if (n >= 105) sum_annx = annx_lwa((uint32_t)values, sum_annx, 104);
    if (n >= 106) sum_annx = annx_lwa((uint32_t)values, sum_annx, 105);
    if (n >= 107) sum_annx = annx_lwa((uint32_t)values, sum_annx, 106);
    if (n >= 108) sum_annx = annx_lwa((uint32_t)values, sum_annx, 107);
    if (n >= 109) sum_annx = annx_lwa((uint32_t)values, sum_annx, 108);
    if (n >= 110) sum_annx = annx_lwa((uint32_t)values, sum_annx, 109);
    if (n >= 111) sum_annx = annx_lwa((uint32_t)values, sum_annx, 110);
    if (n >= 112) sum_annx = annx_lwa((uint32_t)values, sum_annx, 111);
    if (n >= 113) sum_annx = annx_lwa((uint32_t)values, sum_annx, 112);
    if (n >= 114) sum_annx = annx_lwa((uint32_t)values, sum_annx, 113);
    if (n >= 115) sum_annx = annx_lwa((uint32_t)values, sum_annx, 114);
    if (n >= 116) sum_annx = annx_lwa((uint32_t)values, sum_annx, 115);
    if (n >= 117) sum_annx = annx_lwa((uint32_t)values, sum_annx, 116);
    if (n >= 118) sum_annx = annx_lwa((uint32_t)values, sum_annx, 117);
    if (n >= 119) sum_annx = annx_lwa((uint32_t)values, sum_annx, 118);
    if (n >= 120) sum_annx = annx_lwa((uint32_t)values, sum_annx, 119);
    if (n >= 121) sum_annx = annx_lwa((uint32_t)values, sum_annx, 120);
    if (n >= 122) sum_annx = annx_lwa((uint32_t)values, sum_annx, 121);
    if (n >= 123) sum_annx = annx_lwa((uint32_t)values, sum_annx, 122);
    if (n >= 124) sum_annx = annx_lwa((uint32_t)values, sum_annx, 123);
    if (n >= 125) sum_annx = annx_lwa((uint32_t)values, sum_annx, 124);
    if (n >= 126) sum_annx = annx_lwa((uint32_t)values, sum_annx, 125);
    if (n >= 127) sum_annx = annx_lwa((uint32_t)values, sum_annx, 126);
    if (n >= 128) sum_annx = annx_lwa((uint32_t)values, sum_annx, 127);
